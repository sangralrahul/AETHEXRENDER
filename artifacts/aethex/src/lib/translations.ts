...
const t: LangMap = {
  en: {
    ...
    buildingPresentation: "SYNAPSE is composing your {n}-slide presentation...",
    ...
    researchTopicPlaceholder: "What topic should SYNAPSE research deeply?",
  ...
  hi: {
    ...
    buildingPresentation: "SYNAPSE आपकी {n}-स्लाइड प्रस्तुति तैयार कर रहा है...",
    ...
    researchTopicPlaceholder: "SYNAPSE किस विषय पर गहराई से शोध करे?",
  ...
  as: {
    ...
    buildingPresentation: "SYNAPSE আপোনাৰ {n}-স্লাইড উপস্থাপন তৈয়াৰ কৰিছে...",
    ...
    researchTopicPlaceholder: "SYNAPSE কোন বিষয়ত গভীৰভাৱে গৱেষণা কৰিব?",
  ...
  bn: {
    ...
    buildingPresentation: "SYNAPSE আপনার {n}-স্লাইড উপস্থাপনা তৈরি করছে...",
    ...
    researchTopicPlaceholder: "SYNAPSE কোন বিষয়ে গভীরভাবে গবেষণা করবে?",
  ...
  brx: {
    ...
    buildingPresentation: "SYNAPSE नों {n}-स्लाइड प्रेजेंटेशन थैयाव लानाय...",
    ...
    researchTopicPlaceholder: "SYNAPSE मावफालिखौ गहिराव खोजो?",
  ...
  doi: {
    ...
    buildingPresentation: "SYNAPSE तुआड़ी {n}-स्लाइड प्रेजेंटेशन बनाई गी ऐ...",
    ...
    researchTopicPlaceholder: "SYNAPSE कस्से विषय पर गहराई कन्नै खोज करे?",
  ...
  gu: {
    ...
    buildingPresentation: "SYNAPSE તમારી {n}-સ્લાઇડ પ્રેઝન્ટેશન તૈયાર કરી રહ્યું છે...",
    ...
    researchTopicPlaceholder: "SYNAPSE કયા વિષય પર ઊંડું સંશોધન કરે?",
  ...
  kn: {
    ...
    buildingPresentation: "SYNAPSE ನಿಮ್ಮ {n}-ಸ್ಲೈಡ್ ಪ್ರಸ್ತುತಿ ರಚಿಸುತ್ತಿದೆ...",
    ...
    researchTopicPlaceholder: "SYNAPSE ಯಾವ ವಿಷಯವನ್ನು ಆಳವಾಗಿ ಸಂಶೋಧಿಸಬೇಕು?",
  ...
  ks: {
    ...
    buildingPresentation: "SYNAPSE تُہنُک {n}-سلائیڈ پریزنٹیشن بناوان چھ...",
    ...
    researchTopicPlaceholder: "SYNAPSE کِس موضوع پیٹھ گہری تحقیق کرے?",
  ...
  kok: {
    ...
    buildingPresentation: "SYNAPSE तुमचें {n}-स्लाइड सादरीकरण तयार करतां...",
    ...
    researchTopicPlaceholder: "SYNAPSE कसल्या विशयार खोल संशोधन करचें?",
  ...
  mai: {
    ...
    buildingPresentation: "SYNAPSE अपनेक {n}-स्लाइड प्रस्तुति बनबैत अछि...",
    ...
    researchTopicPlaceholder: "SYNAPSE केहन विषय पर गहराई सँ शोध करए?",
  ...
  ml: {
    ...
    buildingPresentation: "SYNAPSE നിങ്ങളുടെ {n}-സ്ലൈഡ് അവതരണം തയ്യാറാക്കുന്നു...",
    ...
    researchTopicPlaceholder: "SYNAPSE ഏത് വിഷയത്തിൽ ആഴത്തിൽ ഗവേഷണം നടത്തണം?",
  ...
  mni: {
    ...
    buildingPresentation: "SYNAPSE না নংগী {n}-স্লাইড প্রেজেন্টেশন ফাওহনবা...",
    ...
    researchTopicPlaceholder: "SYNAPSE না কদায়দা অচুম্বা থাজিল্লগে?",
  ...
  mr: {
    ...
    buildingPresentation: "SYNAPSE तुमचे {n}-स्लाइड सादरीकरण तयार करत आहे...",
    ...
    researchTopicPlaceholder: "SYNAPSE कोणत्या विषयावर सखोल संशोधन करावे?",
  ...
  ne: {
    ...
    buildingPresentation: "SYNAPSE ले तपाईंको {n}-स्लाइड प्रस्तुति बनाउँदैछ...",
    ...
    researchTopicPlaceholder: "SYNAPSE ले कुन विषयमा गहिरो अनुसन्धान गरोस्?",
  ...
  or: {
    ...
    buildingPresentation: "SYNAPSE ଆପଣଙ୍କ {n}-ସ୍ଲାଇଡ ଉପସ୍ଥାପନା ପ୍ରସ୍ତୁତ କରୁଛି...",
    ...
    researchTopicPlaceholder: "SYNAPSE କେଉଁ ବିଷୟ ଉପରେ ଗଭୀର ଅନୁସନ୍ଧାନ କରିବ?",
  ...
  pa: {
    ...
    buildingPresentation: "SYNAPSE ਤੁਹਾਡੀ {n}-ਸਲਾਈਡ ਪੇਸ਼ਕਾਰੀ ਤਿਆਰ ਕਰ ਰਿਹਾ ਹੈ...",
    ...
    researchTopicPlaceholder: "SYNAPSE ਕਿਸ ਵਿਸ਼ੇ ਤੇ ਡੂੰਘੀ ਖੋਜ ਕਰੇ?",
  ...
  sa: {
    ...
    buildingPresentation: "SYNAPSE भवतः {n}-स्लाइड प्रस्तुतिं रचयति...",
    ...
    researchTopicPlaceholder: "SYNAPSE कं विषयं गहनतया अन्वेषयतु?",
  ...
  sat: {
    ...
    buildingPresentation: "SYNAPSE ᱟᱢ ᱟᱠᱟᱱ {n}-ᱥᱞᱟᱭᱰ ᱯᱨᱮᱡᱮᱱᱴᱮᱥᱚᱱ ᱵᱟᱱᱟᱣ ᱞᱟᱹᱜᱤᱫ...",
    ...
    researchTopicPlaceholder: "SYNAPSE ᱠᱷᱚᱱ ᱵᱤᱥᱚᱭ ᱨᱮ ᱜᱷᱤᱨ ᱧᱮᱞ ᱢᱮ?",
  ...
  sd: {
    ...
    buildingPresentation: "SYNAPSE توهان جي {n}-سلائيڊ پريزنٽيشن ٺاهي رهيو آهي...",
    ...
    researchTopicPlaceholder: "SYNAPSE ڪهڙي موضوع تي گہري ڳولا ڪري?",
  ...
  ta: {
    ...
    buildingPresentation: "SYNAPSE உங்கள் {n}-சுருக்கம் விளக்கக்காட்சி தயாரிக்கிறது...",
    ...
    researchTopicPlaceholder: "SYNAPSE எந்த தலைப்பில் ஆழமாக ஆராய்ச்சி செய்யட்டும்?",
  ...
  te: {
    ...
    buildingPresentation: "SYNAPSE మీ {n}-స్లైడ్ ప్రెజెంటేషన్ తయారు చేస్తోంది...",
    ...
    researchTopicPlaceholder: "SYNAPSE ఏ విషయంపై లోతుగా పరిశోధన చేయాలి?",
  ...
  ur: {
    ...
    buildingPresentation: "SYNAPSE آپ کی {n}-سلائیڈ پریزنٹیشن تیار کر رہا ہے...",
    deepResearchMode: "گہری تحقیق موڈ",
    presentationMode: "پریزنٹیشن موڈ",
    ...
    researchTopicPlaceholder: "SYNAPSE کس موضوع پر گہری تحقیق کرے؟",
