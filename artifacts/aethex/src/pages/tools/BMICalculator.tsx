  ...
  return (
    <div className="min-h-screen" style={{ background: "#F2F2F7" }}>
      <div className="relative overflow-hidden" >
        <div className="absolute inset-0" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1530026186672-2cd00ffc50fe?w=1600&q=80')", backgroundSize: "cover", backgroundPosition: "center" }} />
