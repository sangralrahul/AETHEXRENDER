  ...
  if (selected) {
    return (
      <div className="min-h-screen" style={{ background: "#F2F2F7" }}>
        ...
        <div className="absolute inset-0" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516549655169-df83a0774514?w=1600&q=80')", backgroundSize: "cover", backgroundPosition: "center" }} />
